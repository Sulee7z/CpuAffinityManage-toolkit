...
public class CpuTopology
{
    ...
    /// <summary>
    /// For each logical processor index i, SmtSiblingMask[i] is the bitmask of
    /// all logical processors belonging to the same physical core (including i itself).
    /// When SMT is off, each entry is simply 1UL &lt;&lt; i.
    /// Size is always 64. Unused entries are 0.
    /// </summary>
    public ulong[] SmtSiblingMask { get; init; } = Array.Empty<ulong>();
